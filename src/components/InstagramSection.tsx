...
const PLACEHOLDER_POSTS = [
  ...
  { id: 2, caption: "Cerrajeria Yale en stock", color: "from-blue-500 to-indigo-600", label: "Seguridad" },
  ...
  { id: 5, caption: "Tornilleria especializada", color: "from-violet-500 to-purple-600", label: "Productos" },
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <p className="section-subtitle mx-auto mt-4">
            Descubre las ultimas novedades, tips ferreteros y promociones exclusivas
          </p>
        </div>
